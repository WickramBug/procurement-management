 ...
 * @author User
 */
public class ViewSavedRequisitions extends javax.swing.JInternalFrame {
    ...
    public ViewSavedRequisitions() {
        initComponents();

    }
    
    public ViewSavedRequisitions(String user,SiteManagerHome home) {
        initComponents();
        this.user=user;
        this.home=home;
        ...
        savedRequsitionTableLoad();
    }
    /**
     * This method is used to fill the table with all the saved requisitions.
     */
    public void savedRequsitionTableLoad() {

        rs = prc.getSavedRequisitionDetails(user);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("VIEW SAVED REQUISITIONS");
        ...
        tableRequsition.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "REQ. NO", "APPLIED DATE", "REQ. DATE", "VIEW", "DELETE"
            }
        ) {
    ...
    private void tableRequsitionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableRequsitionMouseClicked
        ...
        if (col == 3) {
            try{
              ...
              home.createReqClick(Integer.parseInt(tableRequsition.getValueAt(row, 0).toString().substring(5)));
                ...
                int response = JOptionPane.showConfirmDialog(null, "Do you really want to Delete the selected Saved Requisition");
                if (response == 0) {
                    prc.deleteRequisition(Integer.parseInt(tableRequsition.getValueAt(row, 0).toString().substring(5)));
                    savedRequsitionTableLoad();
                   // table.removeRow(row);
                }
